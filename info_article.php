...
echo'
	<div>
			<div id="info_article_left"><img border="0" src="img_article/'.$info_article->code_art.'.png" style="width:400px; height:400px">
			<br><br>
			<div class="fb-like" data-href="'.$page_fb.'" data-send="true" data-width="250"></div></div>
			
			
			
			<div id="info_article_right"><h1>'.$info_article->design_courte_art.'</h1>
			
			<div id="ref_article"><b>Réference : </b><span> '.$CA.'</span>
			<p>'.$info_article->design_long_art.'</p>
					<div id="info_article_right_prix">'.$info_article->prix_art.' DT TTC</div>
			</div>';	
...
if($present == true)
{
	...
	echo'
		<form action="" method="post">
			...
			<input border="0" value="submit" src="style/img/panier/yellow.png" type="image" class="panier"" >
		</form>
	';
}
else
{
	...
	echo'			
		<form action="" method="post">
			...
			<input border="0" value="submit" src="style/img/panier/green.png" type="image" class="panier"" >
		</form>
		';	
}
echo'	</div>
